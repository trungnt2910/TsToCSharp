...
import {ts, ScriptTarget, ModuleResolutionKind, Project} from "ts-morph";
        ...
        interfaceCases.forEach(testCase =>
            {
                ...
                it(testCase.should, () => {
                    ...
                    ast.addSourceFileAtPathIfExists(path.resolve(path.join(definitionsPath,testPath,testFile + ".d.ts")));
